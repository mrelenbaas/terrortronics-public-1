...
# License: GPL v3
# ---------------
# The save_layers_png.py file saves each layer as a PNG.
...
#  understand why.
def save_layers_png(Image, Drawable):
  """The main function."""
  for layer in Image.layers:
    ...
    file_path = 'C:\\Users\\[YOUR USERNAME]\\Desktop\\'+root_file_path+layer.name.replace(' ', '').replace('-', '')+'.png'
...
register(
    'python-fu-save_layers_png',
    'save_layers_png Save layers to PNG',
    'save_layers_png',
    'save_layers_png',
    'Bradley Elenbaas',
    '8/7/2023',
